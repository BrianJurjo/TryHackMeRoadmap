...
**This repository contains a comprehensive list of 350+ ~~free~~** $${\color{red}(As \ of \ June \ 2025 \ some \ rooms \ are}$$ *<ins>premium</ins>* $${\color{red}and \ some \ rooms \ are}$$ *~~private~~* $${\color{red})}$$ **rooms available on TryHackMe (THM) to help you dive into the world of cybersecurity, whether you’re a beginner or looking to sharpen specific skills. TryHackMe offers guided, hands-on rooms that simulate real-world scenarios, making it a valuable resource for anyone interested in network security, penetration testing, web application hacking, and more.**
...
- [ ] ~~[TryHackMe | Welcome](https://tryhackme.com/room/welcome)~~ $${\color{red}Private}$$
...
- [ ] ~~[TryHackMe | CC: Pen Testing](https://tryhackme.com/room/ccpentesting)~~ $${\color{red}Private}$$
...
- [ ] ~~[TryHackMe | Learn Linux](https://tryhackme.com/room/zthlinux)~~ $${\color{red}Private}$$
...
- [ ] <ins>[TryHackMe | Linux Fundamentals Part 2](https://tryhackme.com/room/linuxfundamentalspart2)</ins> $${\color{green}Premium}$$

- [ ] <ins>[TryHackMe | Linux Fundamentals Part 3](https://tryhackme.com/room/linuxfundamentalspart3)</ins> $${\color{green}Premium}$$
